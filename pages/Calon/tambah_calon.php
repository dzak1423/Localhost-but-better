...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    mysqli_query(
        $koneksi,
        "INSERT INTO tbl_calon(nama, email, visi, foto) VALUES ('$nama', '$email', '$visi', '$namabaru')"
    );
}
?>
      ...
      <div class="card mb-4">
        ...
        <div class="card-body px-0 pt-0 pb-2">
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="Kelas" class="form-control-label">email</label>
                    <div class="col-sm-10">
                        <input class="form-control" type="email" value="" id="email" placeholder="Input Email" name="email">
                    </div>  
                <div class="form-group">
                    <label for="Kelas" class="form-control-label">visi</label>
                    <div class="col-sm-10">
                        <input class="form-control" type="text" value="" id="visi" placeholder="Input Visi" name="visi">
                    </div>  
